...
class GuestDocuDetails extends StatefulWidget {
  const GuestDocuDetails({super.key});

  @override
  State<GuestDocuDetails> createState() => _GuestDocuDetailsState();
}
...
class _GuestDocuDetailsState extends State<GuestDocuDetails> {
